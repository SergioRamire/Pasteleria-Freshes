...
class RoleController extends Controller
{
    ...
    public function roleUpdate(Request $request, int $id)
    {
        ...
        return Redirect::route('role.index')->with('success', '¡El rol ha sido actualizado exitosamente!');
    }
    ...
    public function rolePermissionStore(Request $request)
    {
        ...
        return Redirect::route('rolePermission.index')->with('success', 'Permisos Asiganado exitosamente al Role!');
    }
    ...
    public function rolePermissionUpdate(Request $request, Int $id)
    {
        ...
        return Redirect::route('rolePermission.index')->with('success', 'Los permisos del Rol han sido actualizados!');
    }
    ...
    public function rolePermissionDestroy(Int $id)
    {
        ...
        return Redirect::route('rolePermission.index')->with('success', 'Role Eliminado Exitosamente!');
    }
}
