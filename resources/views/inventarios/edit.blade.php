        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4 class="card-title">Editar Inventarios en Sucursales</h4>
                </div>

                <div class="card-body">
                    <form action="{{ route('inventarios.update', $invent->id_inventarios) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_id"><i class="ri-price-tag-3-line me-1"></i> Nombre del Producto</label>
                            ...
                            <div class="form-group col-md-3">
                                <label for="product_code"><i class="ri-qr-code-line me-1"></i> Código del producto</label>
                            ...
                            <div class="form-group col-md-3">
                                <label for="codigo_barras"><i class="ri-barcode-line me-1"></i> Codigo de barras</label>
                            ...
                            <div class="form-group col-md-3">
                                <label for="marca"><i class="ri-shopping-bag-line me-1"></i> Marca</label>
                                <input type="text" class="form-control @error('marca') is-invalid @enderror"
                                       id="marca" name="marca"
                                       value="{{ old('marca', $invent->marca) }}" disabled>
                            </div>

                             <div class="form-group col-md-3">
                                <label for="categoria"><i class="ri-archive-line me-1"></i> Categoria</label>
                            ...
                            <!-- Stock mínimo -->
                            <div class="form-group col-md-3">
                                <label for="product_store"><i class="ri-arrow-down-line me-1"></i> Stock Mínimo <span class="text-danger">*</span></label>
                                <input type="number" min="0" class="form-control @error('stock_minimo') is-invalid @enderror"
                                       name="stock_minimo" value="{{ old('stock_minimo', $invent->stock_minimo) }}" required>
                                @error('stock_minimo')
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            <div>
                                <a href="{{ route('inventarios.index') }}" class="btn btn-danger text-white">
