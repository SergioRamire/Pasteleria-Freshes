    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h3 class="mb-3">Caja de {{ $cajas->first()?->sucursal->nombre ?? 'Sucursal desconocida' }}
                        <i class="fas fa-info-circle text-primary"
                        data-toggle="tooltip"
                        data-placement="right"
                        title="Visualiza en tiempo real los movimientos de la caja de la sucursal actual para llevar un control preciso de ingresos y egresos.">
                        </i>
                    </h3>
                </div>
                <div>
                    <a href="{{ route('caja_sucursal.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>Abrir Caja</a>
        ...
        <div class="col-lg-12 mb-3">
            <form action="{{ route('caja_sucursal.index') }}" method="get">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                <a href="{{ route('caja_sucursal.index') }}" class="input-group-text bg-danger text-white" title="Limpiar búsqueda">
                    ...
                    <tbody class="ligth-body text-center">
                        @forelse ($cajas as $caja)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('caja_sucursal.destroy', $caja->id) }}" method="POST" style="margin-bottom: 5px">
                                    @method('delete')
                                    @csrf
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn btn-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ver Caja"
                                            href="{{ route('caja_sucursal.show', $caja->id) }}"><i class="ri-eye-line mr-0"></i>
                                        </a>
                                         @if($caja->estado == 'abierta')
                                            <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cerrar Caja"
                                                href="{{ route('caja_sucursal.edit', $caja->id) }}"><i class="ri-lock-2-line mr-0"></i>
                                            </a>
                                        @endif
