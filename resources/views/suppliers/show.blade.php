                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="{{ route('suppliers.edit', $supplier->id) }}" class="btn btn-primary font-size-14">
                                <i class="ri-pencil-line mr-0"></i> Editar
                            </a>
                            <a href="{{ route('suppliers.index') }}" class="btn btn-danger font-size-14">
                                <i class="ri-arrow-left-line"></i> Atras
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body p-3">
                    <ul class="list-inline p-0 mb-0">
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-4">
                                    <label class="col-form-label">RFC con Homoclave</label>
                                </div>
                                <div class="col-sm-9 col-8">
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control" value="{{ $supplier->tipo_persona }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-4">
                                    <label class="col-form-label">Nombre Completo del Responsable</label>
                                </div>
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control" value="{{ $supplier->shopname }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-4">
                                    <label class="col-form-label">Dirección Completa</label>
                                </div>
                                <div class="col-sm-9 col-8">
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control" value="{{ $supplier->type }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control" value="{{ $supplier->bank_branch }}" readonly>
                                </div>
                            </div>
                        </li>
                        ...
                        <hr>
                        <!-- Datos Bancarios -->
                        <h5 class="mb-3"><i class="ri-bank-line text-primary"></i> Datos Bancarios</h5>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                <div class="col-sm-3 col-4">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control" value="{{ $supplier->account_holder }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control" value="{{ $supplier->bank_name }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control" value="{{ $supplier->account_number }}" readonly>
                                </div>
                            </div>
                        </li>
                    </ul>
