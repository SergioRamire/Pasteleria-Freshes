                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="header-title">
                            <h4 class="card-title mb-0">
                                ...
                                title="Inspecciona la caja del día actual, revisa las transacciones realizadas hasta el momento.">
                                </i>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="card-body">
                        ...
                        <div class=" row align-items-center">
                            <div class="form-group col-md-6">
                                <label for="nombre_sucursal"><i class="ri-building-line me-1"></i> Sucursal</label>
                                <input type="text" class="form-control @error('nombre_sucursal') is-invalid @enderror" id="nombre_sucursal" name="nombre_sucursal" value="{{ old('nombre_sucursal', $caja->nombre_sucursal) }}" disabled>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-6">
                            ...
                            <div>
                                <a href="{{ route('cajas_sucursales.index') }}" class="btn bg-danger text-white">
                                    <i class="ri-arrow-left-fill mr-1"></i> Regresar
                                </a>
                            </div>

                            <!-- Botón a la derecha -->
                            <div>
                                <a href="{{ route('cajas_sucursales.imprimir_cerrar_caja', $caja->id) }}" target="_blank" class="btn btn-primary">
