    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="cerrarCajaForm" action="{{ route('mis_cajas.update', $caja->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                            ...
                            <div class="form-group col-md-12">
                             ...
                             <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center">No se encontraron transacciones en el día.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
