...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            <h4 class="mb-3">Cotizar Productos
                <i class="fas fa-info-circle text-primary"
                data-toggle="tooltip"
                data-placement="right"
                title="Genera cotizaciones detalladas de productos para tus clientes, personaliza precios y descárgalas en formato PDF para compartir o imprimir.">
                </i>
            </h4>
        </div>
                            ...
                            <div class="form-group col-md-9">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a href="{{ route('cotizaciones.index') }}" class="input-group-text bg-danger text-white" title="Limpiar búsqueda">
                        ...
                        <table class="table table-sm mb-0 small">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- <td>{{ $product->stock }}</td> --}}
                                    <td>
                                        <form action="{{ route('cotizaciones.addCart') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $product->id }}">
                                            <input type="hidden" name="name" value="{{ $product->product_name }}">
                                            <input type="hidden" name="price" value="{{ $product->selling_price }}">
                                            <input type="hidden" name="dealer_price" value="{{ $product->dealer_price }}">
                                            <input type="hidden" name="product_code" value="{{ $product->product_code }}"> {{-- NUEVO --}}
                                            <input type="hidden" name="equivalencia" value="{{ $product->equivalencia }}">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <h5 class="card-title mb-4">
                        Carrito de Cotizaciones <i class="fa-solid fa-cart-shopping text-primary me-2"></i>
                    </h5>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('cotizaciones.updateCart', $item->rowId) }}" method="POST" class="d-flex justify-content-center align-items-center">
                                            @csrf
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('cotizaciones.deleteCart', $item->rowId) }}" class="btn btn-danger btn-sm" title="Borrar producto" onclick="return confirm('¿Eliminar este producto del carrito?')">
                    ...
                    <form action="{{ route('cotizaciones.createInvoice') }}" method="POST" class="mt-4">
                        @csrf
                        <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <form id="vaciar-carrito-form" action="{{ route('cotizaciones.VaciarCarrito') }}" method="POST">
                            @csrf
        ...
        if (barcodeInput) {
            barcodeInput.addEventListener('keypress', function (e) {
                if (e.key === 'Enter') {
                    ...
                    if (barcode.length > 0) {
                        fetch("{{ route('cotizaciones.add-by-barcode') }}", {
                            method: "POST",
                            headers: {
