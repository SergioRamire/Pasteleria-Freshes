    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h3 class="mb-3">Traspasos Solicitados
                        <i class="fas fa-info-circle text-primary"
                        data-toggle="tooltip"
                        data-placement="right"
                        title="Consulta los productos que han sido solicitados desde otras sucursales, con información detallada sobre cada solicitud y su estado.">
                        </i>
                    </h3>
                </div>
            </div>
        ...
        <div class="col-lg-12 mb-3">
            <form action="{{ route('listTraspasosRecibidos.index') }}" method="get">
                <div class="form-row align-items-end">
                    ...
                    <div class="form-group col-md-3">
                        <label for="order_date">
                            <i class="ri-calendar-line"></i> Fecha del traspaso
                        </label>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                <a href="{{ route('listTraspasosRecibidos.index') }}" class="input-group-text bg-danger text-white" title="Limpiar búsqueda">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>{{ ucfirst($traspaso->sucursal_origen_nombre) }}</td>
                            <td>
                                <form action="{{ route('listTraspasosRecibidos.destroy', $traspaso->id) }}" method="POST" style="margin-bottom: 5px">
                                    @method('delete')
                                    @csrf
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn btn-info mr-2" data-toggle="tooltip" data-placement="top" title="Inspeccionar Traspaso" data-original-title="View"
                                            href="{{ route('listTraspasosRecibidos.show', $traspaso->id) }}">
                                            <i class="ri-eye-line mr-0"></i>
                                        </a>

                                        {{-- Botón de imprimir - solo se muestra si el traspaso está recibido --}}
                                        @if($traspaso->estado == 'recibido')
                                            <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="Imprimir Información"
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center">No se encontraron traspasos solicitados.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
