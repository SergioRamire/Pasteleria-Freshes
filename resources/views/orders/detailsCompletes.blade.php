            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Información de pedidos completados</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('order.completeOrders') }}" class="btn btn-danger mr-2" data-toggle="tooltip" data-placement="top" title="Regresar">
