            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Información de pedidos cancelados</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="card-body row">
                            <div class="col-md-4 mb-3">
                                <label class="mb-1 text-muted"><i class="ri-wallet-line me-1"></i> Forma Pagado</label>
                        ...
                        {{-- @if($order->enviar == 1)
                            ...
                            <div class="form-group col-md-12">
                                <label>
                                    <i class="fas fa-truck mr-2 fa-lg me-1 text-primary"></i> Envío a domicilio
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($order->customer->rul_maps) }}"  target="_blank" class="ms-2 text-danger" title="Ver en Google Maps">
                        ...
                        @else
                            ...
                            <div class="form-group col-md-12">
                                <label><i class="fas fa-store mr-2 fa-lg me-1 text-success"></i> Entrega en sucursal</label>
                    ...
                    <a href="{{ route('order.cancelledOrders') }}" class="btn btn-danger mr-2" data-toggle="tooltip" data-placement="top" title="Regresar">
